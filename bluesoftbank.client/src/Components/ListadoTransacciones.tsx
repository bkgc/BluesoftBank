...
const ListadoTransaccionesPage = () => {
    ...
    const GetExtractoAccount = async () => {
        try {
            const response = await axios.get<Usuario[]>(`https://localhost:7222/api/Cuenta/listadotransacciones/${parseInt(year)}/${parseInt(month)}`);
...
export default ListadoTransaccionesPage